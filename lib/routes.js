...
module.exports = function (app) {
	...
	app.get('/api/product/prices/:id/:lat/:long', products.productPrices);
	app.put('/api/product/prices/update', products.updateProductPrice);
	/*
	 */

	// Lists
	app.get('/api/list', lists.userList);
	app.put('/api/list/add', lists.addToList);
	app.delete('/api/list/remove/:listItemId', lists.removeFromList);
	app.put('/api/list/quantity', lists.updateQuantity);
	app.get('/api/list/sort/:lat/:long', sort.sort);
	/*
